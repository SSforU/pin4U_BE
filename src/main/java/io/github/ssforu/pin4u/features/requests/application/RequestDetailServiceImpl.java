...
public class RequestDetailServiceImpl implements RequestDetailService {
    ...
    @Override
    @Transactional // ★ mock 생성 필요하므로 메서드에서 write 허용
    public RequestDetailResponse getRequestDetail(String slug, Integer limit, boolean includeAi /* ignored */) {
        // 1) 요청/역
        ...
        // 4.5) mock 보장: 없는 externalId들에 한해 생성 + 주입
